...
## RESULTS FROM RANDOM REMOVAL OF EDGES/TIME SERIES

#save(mc_nodes,data_vec_list, gdp_sum,pred_ver,gdp_sum_mat,gdp_sum_rel_err,file = "/Users/amantziou/Documents/R_directory_Turing_ONS/collab/results/MC_removal.RData")
load("/Users/amantziou/Documents/R_directory_Turing_ONS/collab/results/MC_removal.RData")
